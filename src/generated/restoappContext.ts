...
import { QueryOperation } from "./restoappComponents";

export type RestoappContext<
 ...
 */
export function useRestoappContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
  _queryOptions?: Omit<
    ...
    "queryKey" | "queryFn"
  >
): RestoappContext<TQueryFnData, TError, TData, TQueryKey> {
  return {
    fetcherOptions: {},
    queryOptions: {},
  };
